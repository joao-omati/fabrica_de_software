...
class InscricaoComunidade(View):
    ...
    def post(self, request):
        ...
        inscritocomunidade = Inscritocomunidade.objects.create( nomeinscrito=nomeinscrito, dtnascimento=dtnascimento,
                                                           nomeresp=nomeresp, grauresp=grauresp, cpfresp=cpfresp, estadocivilresp=estadocivilresp, 
                                                           tellcellresp=tellcellresp, emailresp=emailresp, estadocivilinscrito=estadocivilinscrito, cpfinscrito=cpfinscrito,
                                                           tellcellinscrito=tellcellinscrito, nomecontatourgencia=nomecontatourgencia,contatourgencia=contatourgencia, 
                                                           emailinscrito=emailinscrito, identidadegenero=identidadegenero, etnia=etnia, religiao=religiao, confirmlgpd=confirmlgpd, dthinscricao=dthinscricao)
        
        Endereco.objects.create(idfichacomunidade=inscritocomunidade, cidade=cidade, bairro=bairro, rua=rua, uf=uf, cep=cep)

        Motivoacompanhamento.objects.create(idfichacomunidade=inscritocomunidade, ansiedade=ansiedade, assediomoral=assediomoral, depressao=depressao, dfaprendizagem=dfaprendizagem,
                                            humorinstavel=humorinstavel, insonia=insonia, isolasocial=isolasocial, luto=luto, tristeza=tristeza, apatia=apatia, chorofc=chorofc,
                                            exaustao=exaustao, fadiga=fadiga, faltanimo=faltanimo, vldt=vldt, assediosexual=assediosexual, outro=motivotratoutro)
        
        Medicamento.objects.create(idfichacomunidade=inscritocomunidade, ansiolitico=ansiolitico, antidepressivo=antidepressivo, antipsicotico=antipsicotico, estabhumor=estabhumor,
                                   memoriatct=memoriatct, outro=outromedicamento)
        
        Pcdsnd.objects.create(idfichacomunidade=inscritocomunidade, tea=tea, tdah=tdah, dffs=dffs, dfv=dfv, dfa=dfa, ttap=ttap, ahst=ahst, outro=outropcdsnd)

        Doencafisica.objects.create(idfichacomunidade=inscritocomunidade, doencaresp=doencaresp, cancer=cancer, diabete=diabete, disfusexual=disfusexual, doencadgt=doencadgt,
                                    escleorosemlt=escleorosemlt, hcpt=hcpt, luposatm=luposatm, obesidade=obesidade, pblmarenal=pblmarenal, outro=outradoenca)
        
        Tipoterapia.objects.create(idfichacomunidade=inscritocomunidade, individualift=individualift, individualadt=individualadt, individualadto=individualadto,
                                   individualids=individualids, familia=familia, grupo=grupo, casal=casal)
