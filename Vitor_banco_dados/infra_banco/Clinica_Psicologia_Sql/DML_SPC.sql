...
-- Inserindo dados para a Tabela Inscrito Comunidade
INSERT INTO 
...
-- Inserindo dados para a Tabela Endereço
INSERT INTO 
	endereco (idfichacomunidade, cidade, bairro, rua, cep)
VALUES 
...
-- Inserindo dados para a Tabela Tipo Terapia
INSERT INTO 
	tipoterapia (idfichacomunidade, casal)
VALUES 
	(13, TRUE),
	(21, TRUE);

INSERT INTO 
	tipoterapia (idfichacomunidade, familia)
VALUES
	(9, TRUE),
	(16, TRUE);
	
INSERT INTO 
	tipoterapia (idfichacomunidade, individualadt)
VALUES
	(17, TRUE),
	(22, TRUE),
	(24, TRUE);

-- Inserindo dados para a Tabela pcds ou neurodivergentes
INSERT INTO 
	pcdsnd (idfichacomunidade, tea)
VALUES
	(16, TRUE),
	(24, TRUE);
	
INSERT INTO 
	pcdsnd (idfichacomunidade, dfa)
VALUES
	(10, TRUE),
	(12, TRUE);

INSERT INTO 
	motivoacompanhamento(idfichacomunidade,tristeza,chorofc,depressao) 
VALUES (
	20,
	TRUE,
	TRUE,
...
-- Inserindo dados para a Tabela Medicamento
INSERT INTO 
	medicamento (idfichaconvenio, idfichacomunidade, ansiolitico, antidepressivo, antipsicotico, estabhumor, memoriatct, outro) 
VALUES
...
-- Inserindo dados para a Tabela Doença Fisica
INSERT INTO 
	doencafisica (idfichaconvenio, idfichacomunidade, doencaresp, cancer, diabete, disfusexual, doencadgt, escleorosemlt, hcpt, luposatm, obesidade, pblmarenal, outro) 
VALUES
...
INSERT INTO 
	disponibilidade (idfichaconvenio, idfichacomunidade, manha, tarde, noite, sabado) 
VALUES
...
-- Inserindo dados para a Tabela Coordenador
INSERT INTO 
	coordenador (nome, senha, cpf, crp, crpcoord, emailinst, status) 
VALUES
...
INSERT INTO 
	coordenador (nome, senha, cpf, crp, crpcoord, emailinst, status) 
VALUES('Guilher Monico', MD5('senha123456'), '12345678923', 123089, 12345, 'guilhermeMonico@unieuro.com.br', TRUE);

-- Inserindo dados para a Tabela Supervisor
INSERT INTO 
	supervisor (crpcoord, nome, cpf, crp, senha, emailinst, status) 
VALUES
...
-- Inserindo dados para a Tabela Secretaria
INSERT INTO 
	secretaria (crpcoord, nome, cpf, codfuncionario, senha, emailinst, status) 
VALUES
...
-- Inserindo dados para a Tabela Responsavel Tecnica
INSERT INTO 
	resptec (crpcoord, nome, senha, cpf, crpresp, emailinst, status) 
VALUES
...
-- Inserindo dados para a Tabela Escolha do Estagiario
INSERT INTO 
...
-- Inserindo dados para a Tabela agendamento para salas
INSERT INTO 
...
-- Inserindo dados para a Tabela salas de agendamento
INSERT INTO 
...
-- Inserindo dados para a Tabela Prontuario
INSERT INTO 
...
-- Inserindo dados para a Tabela Folha de Evolução
INSERT INTO 
...
-- Inserindo dados para a Tabela Ficha de Frequencia
INSERT INTO 
...
-- Inserindo dados para a Tabela Anamnese
INSERT INTO 
...
-- Inserindo dados para a Tabela Laudo Medico
INSERT INTO 
...
-- Inserindo dados para a Tabela Arquivo Inscrito
INSERT INTO 
...
-- Inserindo dados para a Tabela Arquivamento
INSERT INTO 
...
-- Inserindo dados para a Tabela Solicitação do Arquivamento
INSERT INTO 
...
-- Inserindo dados para a Tabela Historico de Ocorrencia
INSERT INTO 
