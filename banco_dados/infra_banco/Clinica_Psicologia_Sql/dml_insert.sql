...
INSERT INTO 
	inscritocomunidade (idfichacomunidade, nomeinscrito,dtnascimento, nomeresp, grauresp, cpfresp, estadocivilresp, tellcellresp, emailresp, estadocivilinscrito, cpfinscrito, tellcellinscrito, contatourgencia, nomecontatourgencia, emailinscrito, identidadegenero, etnia, religiao, confirmlgpd, dthinscricao, status, tipodeconsulta)
VALUES
	(1, 'Pedro Alvares Cabral', '2000-01-15', 'Ana Cabral', 'Mãe', '12345678901', 'Solteiro', '11987654321', 'ana.cabral@email.com', 'Solteiro', '01234567890', '11998765432', '11991234567', 'Joana Cabral', 'pedro.cabral@email.com', 'Masculino', 'Branca', 'Católico', TRUE, '2024-05-01', TRUE, 'avaliação inicial'),
	(2, 'Maria da Silva Souza', '1995-03-20', 'Carlos Souza', 'Pai', '23456789012', 'Casado', '21976543210', 'carlos.souza@email.com', 'Casado', '12345678901', '21987654321', '21992345678', 'Fernanda Souza', 'maria.souza@email.com', 'Feminino', 'Parda', 'Evangélico', TRUE, '2024-05-02', TRUE, 'retorno'), 
	(3, 'João Victor Oliveira', '2002-07-01', 'Patrícia Oliveira', 'Mãe', '34567890123', 'Divorciado', '31965432109', 'patricia.oliver@email.com', 'Solteiro', '23456789012', '31998765432', '31993456789', 'Roberto Oliveira', 'joao.oliver@email.com', 'Masculino', 'Preta', 'Espirita', TRUE, '2024-05-03', TRUE, 'consulta de emergência'),
	(4, 'Ana Clara Santos', '1988-11-10', 'Márcia Santos', 'Mãe', '45678901234', 'Viúvo', '41954321098', 'marcia.santos@email.com', 'União Estável', '34567890123', '41987654321', '41994567890', 'Paula Santos', 'ana.santos@email.com', 'Feminino', 'Branca', 'Sem religião', TRUE, '2024-05-04', TRUE, 'acompanhamento'),
	(5, 'Lucas Martins Lima', '2005-02-28', 'Ricardo Lima', 'Pai', '56789012345', 'União Estável', '51943210987', 'ricardo.lima@email.com', 'Solteiro', '45678901234', '51987654321', '51995678901', 'Silvia Lima', 'lucas.lima@email.com', 'Masculino', 'Amarela', 'Budismo', TRUE, '2024-05-05', TRUE, 'consulta médica'),
	(6, 'Fernanda Costa Alves', '1990-09-05', 'Mariana Alves', 'Mãe', '67890123456', 'Solteiro', '61932109876', 'mariana.alves@email.com', 'Divorciado', '56789012345', '61987654321', '61996789012', 'Rafael Alves', 'fernanda.alves@email.com', 'Feminino', 'Parda', 'Católico', TRUE, '2024-05-06', TRUE, 'consulta médica'),
	(7, 'Guilherme Pereira Neto', '1998-04-12', 'Sonia Neto', 'Mãe', '78901234567', 'Casado', '71921098765', 'sonia.neto@email.com', 'Solteiro', '67890123456', '71987654321', '71997890123', 'Eduardo Neto', 'guilherme.neto@email.com', 'Masculino', 'Indígena', 'Religião de Matriz Africana', TRUE, '2024-05-07', TRUE, 'consulta de emergência'),
	(8, 'Isabela Gomes Ribeiro', '2001-08-30', 'Antônio Ribeiro', 'Pai', '89012345678', 'Divorciado', '81910987654', 'antonio.ribeiro@email.com', 'Solteiro', '78901234567', '81987654321', '81998901234', 'Carla Ribeiro', 'isabela.ribeiro@email.com', 'Feminino', 'Preta', 'Evangélico', TRUE, '2024-05-08', TRUE, 'avaliação inicial'),
	(9, 'Henrique Rocha Costa', '1993-06-18', 'Cristina Costa', 'Mãe', '90123456789', 'Viúvo', '91909876543', 'cristina.costa@email.com', 'Casado', '89012345678', '91987654321', '91999012345', 'Felipe Costa', 'henrique.costa@email.com', 'Masculino', 'Branca', 'Hinduísmo', TRUE, '2024-05-09', TRUE, 'retorno'),
	(10, 'Julia Pires Mendes', '2004-10-25', 'Paulo Mendes', 'Pai', '01234567890', 'União Estável', '11987654321', 'paulo.mendes@email.com', 'Solteiro', '90123456789', '11998765432', '11991234567', 'Denise Mendes', 'julia.mendes@email.com', 'Feminino', 'Parda', 'Islamismo', TRUE, '2024-05-10', TRUE, 'retorno'),
	(11, 'Leonardo Barreto Cordeiro', '1997-01-03', 'Flávia Cordeiro', 'Mãe', '12345678902', 'Solteiro', '21976543210', 'flavia.cordeiro@email.com', 'Solteiro', '01234567891', '21987654321', '21992345678', 'Gustavo Cordeiro', 'leonardo.cordeiro@email.com', 'Masculino', 'Preta', 'Judaismo', TRUE, '2024-05-11', TRUE, 'consulta médica'),
	(12, 'Beatriz Neves Vasconcelos', '1985-05-14', 'Rodrigo Vasconcelos', 'Pai', '23456789013', 'Casado', '31965432109', 'rodrigo.vasconcelos@email.com', 'Casado', '12345678902', '31998765432', '31993456789', 'Valeria Vasconcelos', 'beatriz.vasconcelos@email.com', 'Feminino', 'Branca', 'Outros', TRUE, '2024-05-12', TRUE, 'consulta médica'),
	(13, 'Caique Gomes Santos', '2003-09-08', 'Mônica Santos', 'Mãe', '34567890124', 'Divorciado', '41954321098', 'monica.santos@email.com', 'Solteiro', '23456789013', '41987654321', '41994567890', 'Thiago Santos', 'caique.santos@email.com', 'Masculino', 'Amarela', 'Sem religião', TRUE, '2024-05-13', TRUE, 'acompanhamento'),
	(14, 'Diana Sales Mendes', '1999-12-22', 'Alexandre Mendes', 'Pai', '45678901235', 'Viúvo', '51943210987', 'alexandre.mendes@email.com', 'União Estável', '34567890124', '51987654321', '51995678901', 'Mariana Mendes', 'diana.mendes@email.com', 'Feminino', 'Indígena', 'Católico', TRUE, '2024-05-14', TRUE, 'consulta de emergência'),
	(15, 'Emanuel Diniz Almeida', '2006-03-01', 'Carolina Almeida', 'Mãe', '56789012346', 'União Estável', '61932109876', 'carolina.almeida@email.com', 'Solteiro', '45678901235', '61987654321', '61996789012', 'Luiz Almeida', 'emanuel.almeida@email.com', 'Masculino', 'Parda', 'Evangélico', TRUE, '2024-05-15', TRUE, 'retorno'),
	(16, 'Fabiana Leal Batista', '1992-07-16', 'João Batista', 'Pai', '67890123457', 'Solteiro', '71921098765', 'joao.batista@email.com', 'Divorciado', '56789012346', '71987654321', '71997890123', 'Regina Batista', 'fabiana.batista@email.com', 'Feminino', 'Preta', 'Espirita', TRUE, '2024-05-16', TRUE, 'acompanhamento'),
	(17, 'Gabriel Rocha Siqueira', '2000-11-09', 'Laura Siqueira', 'Mãe', '78901234568', 'Casado', '81910987654', 'laura.siqueira@email.com', 'Solteiro', '67890123457', '81987654321', '81998901234', 'Daniel Siqueira', 'gabriel.siqueira@email.com', 'Masculino', 'Branca', 'Budismo', TRUE, '2024-05-17', TRUE, 'consulta médica'),
	(18, 'Heloisa Santos Silva', '1996-02-04', 'Fernando Silva', 'Pai', '89012345679', 'Divorciado', '91909876543', 'fernando.silva@email.com', 'Casado', '78901234568', '91987654321', '91999012345', 'Bianca Silva', 'heloisa.silva@email.com', 'Feminino', 'Amarela', 'Hinduísmo', TRUE, '2024-05-18', TRUE, 'acompanhamento'),
	(19, 'Igor Vasconcelos Costa', '2004-08-20', 'Juliana Costa', 'Mãe', '90123456780', 'Viúvo', '11987654321', 'juliana.costa@email.com', 'Solteiro', '89012345679', '11998765432', '11991234567', 'Miguel Costa', 'igor.costa@email.com', 'Masculino', 'Indígena', 'Islamismo', TRUE, '2024-05-19', TRUE, 'avaliação inicial'),
	(20, 'Juliana Dantas Almeida', '1991-04-10', 'Cesar Almeida', 'Pai', '01234567893', 'Solteiro', '21976543210', 'cesar.almeida@email.com', 'Divorciado', '90123456780', '21987654321', '21992345678', 'Alice Almeida', 'juliana.almeida@email.com', 'Feminino', 'Parda', 'Judaismo', TRUE, '2024-05-20', TRUE, 'acompanhamento'); 
